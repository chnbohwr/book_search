...
<div class="mgt10">
    <div class="search-form">
        <input type="search" class="form-control" type="text" maxlength="30" v-el:search_text @keyup.enter="getBook(true)" placeholder="input book name" />
    ...
    <infinite-loading :distance="infinite_distance" :on-infinite="getBook" v-if="state.searchBook.totalItem > 0 && state.searchBook.books.length < state.searchBook.totalItem">
    </infinite-loading>
</div>
